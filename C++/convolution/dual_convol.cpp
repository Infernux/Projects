...
void DualConvol::convol(uint8_t* out, uint8_t* img, Filter filter, int x, int y, int stride)
{
  double n = 0.f, n2 = 0.f;
...
void DualConvol::apply_filter(uint8_t* out, uint8_t* padded_img, Filter filter, int width, int height, int padding)
{
