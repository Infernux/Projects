...
class PQType(object):
    __slots__ = ('id', 'tags', 'isInitial', 'isFinal', 'vehClasses', 'tileID', 'chainID', 'internalID', 'requiredUnlocks', 'mainQuestID', 'addQuestID', 'mainQuestInfo', 'addQuestInfo', 'userString', 'description', 'advice', 'conditionMain', 'conditionAdd', 'minLevel', 'maxLevel')
...
+++ okay decompyling potapov_quests.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2015.01.14 22:43:03 CET
