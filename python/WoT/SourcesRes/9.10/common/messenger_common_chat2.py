...
_MESSENGER_ACTION_NAMES = dict(((_id, _name) for (_name, _id,) in MESSENGER_ACTION_IDS.__dict__.iteritems() if type(_id) is int if not _name.startswith('_')))
...
+++ okay decompyling messenger_common_chat2.pyc 
