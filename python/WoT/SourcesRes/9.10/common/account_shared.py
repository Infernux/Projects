...
def validateCustomizationItem(custData):
    ...
    if value is None or value == 0 or isPermanent is None:
        return (False, 'Invalid args')
    if custType not in ('emblems', 'camouflages', 'inscriptions'):
...
+++ okay decompyling account_shared.pyc 
