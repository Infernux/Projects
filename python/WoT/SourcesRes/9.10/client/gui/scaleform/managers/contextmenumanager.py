...
class VehicleContextMenuHandler(AbstractContextMenuHandler, EventSystemEntity):
    ...
    def checkFavoriteVehicle(self):
        self._VehicleContextMenuHandler__favoriteVehicle(True)



    def uncheckFavoriteVehicle(self):
        self._VehicleContextMenuHandler__favoriteVehicle(False)
...
+++ okay decompyling contextmenumanager.pyc 
